            ...
            <section id="section3">
               <div className="container">
                   <div className="gap">
                       <div className="title">
                           <h2>WHY CHOOSE US?</h2>
                           <h3>We are delivering beautiful digital products for you</h3>
                       </div>
                           ...
                           <ul>
                                   ...
                                   <div className="col-gap">
                                       <div className="col-wrap">
                                           <div className="text-box">
                                               <h4><i className="fas fa-desktop"></i></h4>
                                               <h5>Unique Design</h5>
                               ...
                               <li>
                                   <div className="col-gap">
                                       <div className="col-wrap">
                                           <div className="text-box">
                                               <h4><i className="fas fa-pencil-ruler"></i></h4>
                               ...
                               <li>
                                    <div className="col-gap">
                                        <div className="col-wrap">
                                            <div className="text-box">
                                                <h4><i className="fas fa-bullseye"></i></h4>
